...
if len(sys.argv) == 2:
    ...
    print (f"\n Usage: {sys.argv[0]} < Hostname > < Port > < 100000000 >")
    sys.exit(1)
...
def print_status():
    ...
    sys.stdout.flush()
    print (f"\033[95m══>> \033[92m[KIM\033[33mOKI\033[32mKUN\033[33m-4] \033[32mREQUEST_NUM \033[92m" +str(ip)+ "\033[0m")
    sys.stdout.write(f"\r[💥] \033[95m{time.ctime().split( )[3]}\033[94m [{str(thread_num)}] ")
    sys.stdout.flush()
    print (f"\033[37m══>> \033[33m[KIM\033[37mOKI\033[33mKUN\033[37m-4] \033[36mREQUEST_NUM \033[35m" +str(ip)+ "\033[0m")
